...
TEST(RouterTest, Ambiguous)
{
    ...
    *r.insert("/hello/:a/world") = "handler1";
    *r.insert("/hello/:b/world/:c") = "handler2";
    *r.insert("/hello/:d/world/:e/:f") = "handler3";
    ...
    handler = **r.find("/hello/100/world", on_path_param);
    ...
    handler = "";
    path_params.clear();
    handler = **r.find("/hello/200/world/300", on_path_param);
    ...
    handler = "";
    path_params.clear();
    handler = **r.find("/hello/400/world/500/600", on_path_param);
